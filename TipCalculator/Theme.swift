...
class Theme {
    ...
    init() {
        ...
        case .dark:
            ...
            billAmountTextColor = #colorLiteral(red: 0.9533321261, green: 0.9377500415, blue: 0.908346355, alpha: 1)
            tipSelectorBackgroundColor = #colorLiteral(red: 0.9533321261, green: 0.9377500415, blue: 0.908346355, alpha: 1)
            ...
            navigationBarBackgroundColor = #colorLiteral(red: 0.1858969927, green: 0.08667428046, blue: 0.1943873167, alpha: 1)
            navigationBarTextColor = #colorLiteral(red: 0.9533321261, green: 0.9377500415, blue: 0.908346355, alpha: 1)
        }
